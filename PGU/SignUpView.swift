        ...
        VStack{
            ...
            if isAuthenticated {
                ...
                HStack {
                    ...
                    Menu {
                        Button("Upstate New York", action: { selectedLocation = "Upstate New York" })
                        Button("Northern Indiana", action: { selectedLocation = "Northern Indiana" })
                        Button("Central Indiana", action: { selectedLocation = "Central Indiana" })
                        Button("Eastern Kansas", action: { selectedLocation = "Eastern Kansas" })
                        Button("Central Kansas", action: { selectedLocation = "Central Kansas" })
                        Button("Western Kansas", action: { selectedLocation = "Western Kansas" })
                        Button("Eastern Colorado", action: { selectedLocation = "Eastern Colorado" })
                        Button("Nebraska", action: { selectedLocation = "Nebraska" })
    ...
    func signUpUser(email: String, password: String) {
        Auth.auth().createUser(withEmail: email, password: password) { authResult, error in
            if let error = error {
                ...
                Analytics.setUserProperty(selectedLocation, forName: "user_location")
